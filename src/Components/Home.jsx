      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          >
            ...
            <motion.h1 variants={fadeInUp} className="text-5xl font-bold leading-tight md:text-7xl text-white">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Full Stack</span>
              <br />
              Development
            </motion.h1>

            <motion.p variants={fadeInUp} className="max-w-lg text-xl text-softGray">
              {personal.role} based in {personal.location} with a passion for building scalable and beautiful web applications.
            </motion.p>
          ...
          >
            <div className="p-8 ">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="mt-2 text-2xl font-bold text-white">{personal.name}</h3>
                ...
                <div className="flex gap-4 mt-4">
                  <a href="https://github.com/sheerazpaul" target="_blank" rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-card-glass border border-white/10 backdrop-blur-md flex items-center justify-center text-softGray hover:bg-primary hover:text-white transition-all shadow-lg">
